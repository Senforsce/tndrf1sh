...
func NoComponent() t1.Component {
	return t1.ComponentFunc(func(ctx context.Context, t1_7745c5c3_W io.Writer) (t1_7745c5c3_Err error) {
		...
		_, t1_7745c5c3_Err = t1_7745c5c3_Buffer.WriteString("<svg version=\"1.1\" id=\"Uploaded to svgrepo.com\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" width=\"800px\" height=\"800px\" viewBox=\"0 0 32 32\" xml:space=\"preserve\"><style type=\"text/css\">\r\n\t.feather_een{fill:#21212c;}\r\n\t.st0{fill:#0B1719;}\r\n</style><path class=\"feather_een\" d=\"M25,2H7C5.343,2,4,3.343,4,5v22c0,1.657,1.343,3,3,3h18c1.657,0,3-1.343,3-3V5C28,3.343,26.657,2,25,2z
...
\n	C22.776,24,23,24.224,23,24.5z\"></path></svg>")
